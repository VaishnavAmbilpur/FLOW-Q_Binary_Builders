...
import { Terminal, Shield, ArrowRight, Activity, Server } from "lucide-react";
...
export default function AdminSignup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem(
        "organizationId",
        loginRes.data.admin.organizationId,
      );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-fuchsia-50 to-white dark:from-[#0c0516] dark:via-[#1a0b2e] dark:to-[#0c0516] flex items-center justify-center p-6 relative overflow-hidden transition-colors">
      ...
      <div className="w-full max-w-5xl flex gap-12 items-center relative z-10">
        ...
        <div className="hidden lg:flex flex-col flex-1 pl-8">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-10 leading-relaxed font-light">
            Create an admin workspace to orchestrate multi-tenant queues,
            provision Webhooks, and manage B2B API access for your entire
            organization system.
          </p>
          ...
          <div className="space-y-6">
            <Feature
              ...
              desc="Generate and revoke keys instantly with SHA-256 hashing."
            />
            <Feature
              icon={<Activity />}
              title="Real-time Webhooks"
              desc="Listen to queue and agent state changes securely."
            />
            <Feature
              icon={<Server />}
              title="Multi-tenant Segregation"
              desc="100% data isolation for massive enterprise scale."
            />
          </div>
        </div>
        ...
        <div className="w-full max-w-md flex-shrink-0 animate-fadeInUp">
          <div className="bg-white/80 dark:bg-[#110c21]/80 backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
            ...
            <div className="text-center mb-8 relative z-10">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">
                Provision your Organization Admin environment
              </p>
            </div>
            ...
            <div className="mt-8 text-center relative z-10">
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                ...
                <Link
                  ...
                  className="text-fuchsia-400 font-bold hover:text-fuchsia-300"
                >
                  Sign in
                </Link>
              </p>
...
function Feature({ icon, title, desc }) {
  return (
    <div className="flex items-start gap-4 p-4 rounded-2xl hover:bg-black/5 dark:hover:bg-white/5 transition-colors group">
      <div className="p-3 rounded-xl bg-fuchsia-500/10 text-fuchsia-500 dark:text-fuchsia-400 group-hover:bg-fuchsia-500/20 group-hover:scale-110 transition-all">
        {icon}
      </div>
      <div>
