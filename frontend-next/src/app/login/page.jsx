          ...
          <div className="relative z-10 max-w-sm space-y-8 animate-fade-left">
            <div className="space-y-4">
              ...
              <p className="text-neutral-500 text-sm font-medium leading-relaxed">
                A high-fidelity business management system designed for speed,
                precision, and world-class service quality.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Global queue synchronization across all nodes.",
                },
                {
                  icon: Shield,
                  title: "Ledger Security",
                  desc: "Encrypted role-based access for all team members.",
                },
                {
                  icon: Users,
                  title: "Flow Optimization",
                  desc: "Smart predictions for customer throughput.",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="flex items-center gap-4 bg-white/[0.03] border border-white/5 p-3.5 md:p-4 rounded-xl hover:bg-white/[0.07] transition-all group"
                >
                  ...
                  <div>
                    <h4 className="font-black text-white text-[9px] uppercase tracking-widest mb-0.5">
                      {item.title}
                    </h4>
                    <p className="text-neutral-500 text-[9px] font-bold">
                      {item.desc}
                    </p>
                  </div>
                </div>
