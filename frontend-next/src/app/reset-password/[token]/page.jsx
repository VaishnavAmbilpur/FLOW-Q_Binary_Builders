...
export default function ResetPassword() {
    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          "Failed to reset. Link invalid or expired.",
      );
    } finally {
      setIsLoading(false);
    }
  ...
  if (isSuccess) {
    return (
      ...
      >
        <div className="relative w-full max-w-[400px] bg-white/80 dark:bg-white/5 backdrop-blur-2xl border border-black/5 dark:border-white/10 shadow-2xl rounded-2xl p-6 animate-fadeIn text-center">
          ...
          <div className="mt-8">
            <Link
              href="/login"
              className="font-bold text-primary-600 dark:text-light-blue-400 hover:underline"
            >
              Go to Login Now
            </Link>
          </div>
    ...
    >
      ...
      >
        <div>
          ...
          <p className="mt-2 text-center text-[10px] font-black uppercase tracking-widest text-gray-600 dark:text-gray-400">
        ...
        <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
          ...
          <div className="text-center mt-4">
            <Link
              href="/login"
              className="text-sm font-bold text-primary-600 dark:text-light-blue-400 hover:underline"
            >
              Back to Login
            </Link>
          </div>
