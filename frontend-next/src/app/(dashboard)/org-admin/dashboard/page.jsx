      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 pt-6 pb-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 animate-fade-down">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl sm:text-3xl font-black tracking-tight text-white mb-1 italic uppercase decoration-brand-500/30 underline-offset-4">
                Admin Dashboard
              </h1>
              <p className="text-neutral-100 text-[10px] font-black uppercase tracking-[0.4em]">
                {admin.organizationId?.name || "Organization"}{" "}
                <span className="mx-2 text-neutral-800">/</span> Control Center
              </p>
            </div>
          </div>
        </div>
          ...
          {[
            {
              ...
              color: "text-brand-400 bg-brand-500/5 border-brand-500/20",
            },
            {
              label: "Operators",
              value: operators.length,
              icon: <Users className="w-5 h-5" />,
              color: "text-success-400 bg-success-500/5 border-success-500/20",
            },
            {
              label: "Queue Load",
              value: "84%",
              icon: <Activity className="w-5 h-5" />,
              color: "text-info-400 bg-info-500/5 border-info-500/20",
            },
            {
              label: "System Status",
              value: "Live",
              icon: <ShieldCheck className="w-5 h-5" />,
              color: "text-warning-400 bg-warning-500/5 border-warning-500/20",
            },
            ...
            >
              <div className="absolute top-4 right-4 sm:top-5 sm:right-5 opacity-40 group-hover:opacity-100 transition-opacity translate-y-[-2px]">
                {icon}
              </div>
              <span className="text-2xl sm:text-4xl font-black tracking-tighter mb-1 font-mono text-white">
                {value.toString().padStart(2, "0")}
              </span>
              <p className="text-[10px] sm:text-[11px] uppercase font-bold tracking-wider text-neutral-100">
                {label}
              </p>
            </div>
          ))}
        ...
        <div className="space-y-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10">
            ...
            <div className="bg-white/5 border border-white/10 rounded-[1.5rem] sm:rounded-[2.5rem] p-5 sm:p-6 backdrop-blur-3xl relative overflow-hidden animate-fade-up">
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <h2 className="text-lg sm:text-xl font-black tracking-tight text-white uppercase tracking-[0.2em]">
                  Add New Agent
                </h2>
              </div>
              ...
              <form onSubmit={handleAddAgent} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold text-neutral-100 uppercase tracking-wider ml-5 italic">
                      Agent Name
                    </label>
                    <input
            ...
            <div className="bg-white/5 border border-white/10 rounded-[1.5rem] sm:rounded-[2.5rem] p-5 sm:p-6 backdrop-blur-3xl relative overflow-hidden animate-fade-up delay-100">
              ...
              <form onSubmit={handleAddOperator} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <label className="text-[9px] font-black text-neutral-100 uppercase tracking-[0.3em] ml-5">
                    Password
                  </label>
                  <input
                    type="password"
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                    {agents.map((d) => (
                      <button
                        ...
                        className={`p-3 rounded-xl border text-[8px] font-black uppercase tracking-widest transition-all ${operatorForm.assignedAgents.includes(d._id) ? "bg-white text-black border-white shadow-xl scale-105" : "bg-white/5 border-white/5 text-neutral-100 hover:border-white/20"}`}
                      >
                        {d.name.split(" ").pop()}
                      </button>
                    ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10">
            ...
            <div className="space-y-4 animate-fade-up delay-200">
              <h3 className="text-[10px] font-bold uppercase tracking-wider text-neutral-300 px-6 italic">
                Active Agents
              </h3>
              <div className="space-y-3">
                {agents.length === 0 ? (
                  <div className="p-8 text-center bg-white/5 border border-white/5 rounded-3xl text-neutral-200 font-bold uppercase tracking-widest text-[9px]">
                  ...
                  agents.map((agent) => (
                    <div
                      key={agent._id}
                      className="group bg-white/[0.03] border border-white/5 p-4 rounded-2xl hover:bg-white/[0.06] hover:border-white/20 transition-all backdrop-blur-sm"
                    >
                      <div className="flex items-center justify-between gap-4">
                        <div className="flex items-center gap-4 min-w-0">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-[8px] font-black text-neutral-200 uppercase tracking-widest">
                        ...
                        <div className="flex items-center gap-1.5 flex-shrink-0">
                          <button
                            ...
                            className="p-2.5 bg-white/5 border border-white/10 rounded-xl hover:bg-brand-500 hover:text-white transition-all"
                            title="Reveal Info"
                          >
                          ...
                          <button
                            ...
                            className="p-2.5 bg-white/5 border border-white/10 rounded-xl hover:bg-info-500 hover:text-white transition-all"
                          ...
                          <button
                            onClick={() =>
                              handleDeleteStaff(agent._id, agent.name)
                            }
                            className="p-2.5 bg-white/5 border border-white/10 rounded-xl hover:bg-danger-500 hover:text-white transition-all text-danger-500 hover:border-danger-500"
                            title="Delete Agent"
                          >
                      ...
                      {revealedIds.includes(agent._id) && (
                        <div className="mt-4 pt-4 border-t border-white/5 grid grid-cols-2 gap-3 animate-fade-down">
                          <div className="p-2.5 bg-black/20 rounded-xl border border-white/5">
                            <p className="text-[7px] font-black text-neutral-100 uppercase tracking-widest mb-1">
                              Email
                            </p>
                          ...
                          <div className="p-2.5 bg-black/20 rounded-xl border border-white/5">
                            ...
                            <p className="text-[10px] font-mono font-bold text-white uppercase">
                              {agent.creationPassword || "Encrypted"}
                            </p>
                          </div>
                        </div>
                      )}
                      ...
                      <div className="flex items-center justify-between gap-4">
                          ...
                          <div className="min-w-0">
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              ...
                              {op.assignedAgents?.length > 0 && (
                                <span className="text-[7px] font-black bg-success-500/20 text-success-400 px-1.5 py-0.5 rounded-full border border-success-500/30">
                                  ASSIGNED
                                </span>
                              )}
                            </div>
                        ...
                        <div className="flex items-center gap-1.5 flex-shrink-0">
                          <button
                            ...
                            className="p-2.5 bg-white/5 border border-white/10 rounded-xl hover:bg-success-500 hover:text-white transition-all font-bold"
                            title="Update Assignment"
                          >
                            <UserPlus className="w-3.5 h-3.5" />
                          </button>
                          <button
                            onClick={() => handleToggleReveal(op._id)}
                            className="p-2.5 bg-white/5 border border-white/10 rounded-xl hover:bg-brand-500 hover:text-white transition-all"
                            title="Recall Info"
                          >
                            <Key className="w-3.5 h-3.5" />
          ...
          <div className="bg-[#0a0a0a] w-full max-w-2xl rounded-[3.5rem] border border-white/10 shadow-[0_0_100px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col max-h-[90vh]">
            <div className="px-10 py-10 border-b border-white/5 flex justify-between items-center bg-white/[0.02]">
              <div>
                ...
                <p className="text-[10px] font-black text-neutral-100 uppercase tracking-[0.4em] mt-1">
                  Professional {editingScheduleAgent.name}
                </p>
              </div>
              <button
                onClick={() => setEditingScheduleAgent(null)}
                className="p-4 bg-white/5 rounded-2xl hover:bg-white/10 transition-all text-neutral-500 hover:text-white"
              >
                <X className="w-6 h-6" />
              </button>
            </div>
            ...
            <div className="p-10 overflow-y-auto custom-scrollbar flex-1 space-y-4">
              {scheduleForm.map((dayObj, i) => (
                <div
                  key={dayObj.day}
                  className="grid grid-cols-3 gap-6 items-center bg-white/[0.03] p-5 rounded-[1.5rem] border border-white/5 hover:border-brand-500/30 transition-all"
                >
                  <div className="font-black text-[10px] uppercase tracking-widest text-neutral-100 pl-2">
                    {dayObj.day}
                  </div>
                  <div className="space-y-1">
                    <p className="text-[8px] font-black text-neutral-100 uppercase tracking-widest">
                      START
                    </p>
                    <input
                      type="time"
            ...
            <div className="p-10 border-t border-white/5 bg-white/[0.02] flex justify-end gap-4">
              <button
                onClick={() => setEditingScheduleAgent(null)}
                className="px-8 py-4 rounded-[1.5rem] text-[10px] font-black uppercase tracking-widest text-neutral-600 hover:text-white transition-all"
              >
                Back
              </button>
              <button
                ...
                disabled={loading}
                className="px-10 py-4 rounded-[1.5rem] bg-brand-600 hover:bg-brand-500 text-white font-black text-[10px] uppercase tracking-widest shadow-2xl shadow-brand-600/20 transition-all active:scale-95"
              >
                Save Schedule
              </button>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-8 bg-black/80 backdrop-blur-xl animate-fadeIn">
          <div className="bg-[#0a0a0a] w-full max-w-md rounded-[3.5rem] border border-white/10 shadow-[0_0_100px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col max-h-[80vh]">
            <div className="px-10 py-10 border-b border-white/5 bg-white/[0.02]">
              ...
              <p className="text-[10px] font-black text-neutral-100 uppercase tracking-[0.4em] mt-1">
                Reassigning {editingAssignmentOp.name}
              </p>
            </div>
            ...
            <div className="p-10 overflow-y-auto custom-scrollbar flex-1 space-y-3">
              {agents.map((d) => (
                <button
                  key={d._id}
                  onClick={() =>
                    handleUpdateAssignment(editingAssignmentOp._id, d._id)
                  }
                  className={`w-full flex items-center gap-5 p-6 rounded-[2rem] border transition-all text-left ${editingAssignmentOp.assignedAgents?.some((ad) => ad._id === d._id || ad === d._id) ? "bg-brand-600 text-white border-brand-500 shadow-2xl" : "bg-white/5 border-white/5 text-neutral-100 hover:border-white/20"}`}
                >
                  <div
                    className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all ${editingAssignmentOp.assignedAgents?.some((ad) => ad._id === d._id || ad === d._id) ? "bg-white/20" : "bg-white/5"}`}
                  >
                  ...
                  <div className="min-w-0">
                    ...
                    <p
                      className={`text-[10px] font-black uppercase tracking-widest ${editingAssignmentOp.assignedAgents?.some((ad) => ad._id === d._id || ad === d._id) ? "text-white/60" : "text-neutral-700"}`}
                    >
                      {d.serviceCategory}
                    </p>
                  </div>
                  {editingAssignmentOp.assignedAgents?.some(
                    (ad) => ad._id === d._id || ad === d._id,
