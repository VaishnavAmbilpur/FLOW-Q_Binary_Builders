    ...
    async function changeAvailability(state: string) {
        try {
            await api.put("/agents/availability", {
                availability: state,
                statusMessage: state === "Unavailable" || state === "Not Available" ? statusMessage : ""
            });
            setAgent((prev: any) => ({
                ...prev,
                availability: state,
        ...
        <div className="w-full min-h-screen bg-neutral-950 text-white font-sans relative overflow-hidden transition-colors duration-300 selection:bg-brand-500/30">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-6 md:py-8 relative z-10">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-1">
                                <h1 className="text-xl sm:text-3xl font-black tracking-tight text-white line-clamp-1 uppercase italic">Agent Dashboard</h1>
                                <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider border animate-pulse ${agent.availability === "Available" 
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10 animate-fade-up delay-100">
                    {[
                        {
                            label: "Total Served", value: summary?.completed ?? "00",
                        ...
                        {
                            label: "Avg Session", value: summary?.avgConsultTime ? `${summary.avgConsultTime.toString().padStart(2, '0')}m` : "--",
                    ...
                    <div className="lg:col-span-4 space-y-8 animate-fade-up delay-200">
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-[3rem] p-8 backdrop-blur-3xl shadow-2xl relative overflow-hidden">
                            ...
                            <div className="space-y-4">
                                <button
                                    ...
                                    className={`w-full py-5 rounded-2xl font-black text-xs uppercase tracking-widest border transition-all flex items-center justify-center gap-3 ${agent.availability === "Available"
                                ...
                                <button
                                    ...
                                    className={`w-full py-5 rounded-2xl font-black text-xs uppercase tracking-widest border transition-all flex items-center justify-center gap-3 ${agent.availability === "Unavailable" || agent.availability === "Not Available"
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-[3rem] p-8 backdrop-blur-3xl shadow-2xl relative overflow-hidden">
                            <div className="flex items-center gap-3 mb-8">
                                ...
                                <h3 className="text-xs font-black uppercase tracking-[0.3em] text-neutral-400">Session Timing</h3>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="p-4 bg-white/5 border border-white/5 rounded-[2rem] flex items-center gap-4">
                                    ...
                                    <div className="flex-1 truncate">
                                        ...
                                        <p className="text-xs font-bold text-neutral-300 truncate">{agent.email}</p>
                                    </div>
                                </div>
                                <div className="p-4 bg-white/5 border border-white/5 rounded-[2rem] flex items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-[10px] font-bold uppercase tracking-wider text-neutral-500 mb-0.5 italic">Permissions</p>
                                        <p className="text-xs font-bold text-neutral-300">Advanced Agent</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-[3.5rem] p-8 shadow-2xl backdrop-blur-3xl min-h-[600px] flex flex-col">
                            ...
                            {queue.length === 0 ? (
                                <div className="flex-1 flex flex-col items-center justify-center text-center">
                                    ...
                                    <p className="text-neutral-500 text-sm mt-1 max-w-[240px] font-medium">Ready for new arrivals.</p>
                                </div>
                            ) : (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex flex-col mb-1">
                                                    <p className="text-base sm:text-lg font-black text-white truncate group-hover:text-brand-400 transition-colors uppercase tracking-tight">{p.clientName || p.name}</p>
                                                    <p className="text-[7px] font-black uppercase tracking-[0.2em] text-neutral-500 italic">Assigned to: {agent.name}</p>
                                                    {idx === 0 && <span className="w-fit mt-1 px-1.5 py-0.5 bg-brand-500 text-white text-[7px] font-black uppercase tracking-[0.2em] rounded-md animate-bounce">Active</span>}
                                                </div>
                ...
                <div className="mt-12 bg-white/5 border border-white/10 rounded-[3.5rem] p-8 shadow-2xl backdrop-blur-3xl">
                    <div className="flex items-center justify-between mb-8 pb-6 border-b border-white/5">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-xl font-black tracking-tight text-white uppercase italic">Upcoming Appointments</h3>
                                <p className="text-[11px] font-bold uppercase tracking-wider text-neutral-500">{appointments.length} in next 7 days</p>
                            </div>
                        </div>
                        <button
                    ...
                    {appointments.length === 0 ? (
                        <div className="py-20 flex flex-col items-center justify-center text-center opacity-40">
                            ...
                            <p className="text-xs font-black uppercase tracking-widest">No scheduled data for this cycle</p>
                        </div>
                    ) : (
                            ...
                            <table className="w-full text-left border-collapse">
                                ...
                                <tbody className="divide-y divide-white/5">
                                    {appointments.map((appt: any) => {
                                        ...
                                        return (
                                            <tr key={appt._id} className="hover:bg-white/[0.03] transition-colors group">
                                                <td className="p-4">
                                                ...
                                                <td className="p-4 hidden md:table-cell">
                                                    {appt.notes ? (
                                                        ...
                                                        <span className="text-neutral-700 text-xs">N/A</span>
                                                    )}
                                                </td>
                                                <td className="p-4">
                                                    <span className={`px-2.5 py-1 text-[9px] uppercase tracking-[0.2em] font-black rounded-md border ${appt.status === 'arrived'
