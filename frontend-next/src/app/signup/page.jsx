        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 sm:px-8 xl:px-20 py-10 border-l border-white/5">
          <div className="w-full max-w-[380px] mx-auto">
            ...
            <div className="mb-6 text-center lg:text-left animate-fade-down">
              <Link
                href="/"
                className="inline-flex items-center gap-2 text-neutral-500 hover:text-white transition-colors mb-6 text-[9px] font-black uppercase tracking-widest bg-white/5 px-3 py-1.5 rounded-full border border-white/10 backdrop-blur-md"
              >
            ...
            {msg && (
              <div
                className={`mb-6 p-4 rounded-2xl border text-[10px] font-black uppercase tracking-widest text-center animate-fade-up shadow-xl backdrop-blur-xl ${
            ...
            <form
              ...
              className="space-y-3.5 animate-fade-up delay-100"
            >
              ...
              <div className="space-y-1">
                ...
                <div className="relative group">
                  <select
                    ...
                    required
                  >
                    <option value="healthcare" className="bg-neutral-900">
                      Healthcare
                    </option>
                    <option value="banking" className="bg-neutral-900">
                      Banking
                    </option>
                    <option value="government" className="bg-neutral-900">
                      Government
                    </option>
                    <option value="education" className="bg-neutral-900">
                      Education
                    </option>
                    <option value="salon" className="bg-neutral-900">
                      Salon
                    </option>
                    <option value="retail" className="bg-neutral-900">
                      Retail
                    </option>
          ...
          <div className="relative z-10 max-w-sm space-y-8 animate-fade-right">
            <div className="space-y-4">
              ...
              <p className="text-neutral-500 text-sm font-medium leading-relaxed">
                Join thousands of service providers leveraging the Architect
                Ledger system to eliminate congestion and maximize customer
                satisfaction.
              </p>
            </div>
            ...
            <div className="bg-white/[0.03] border-l-4 border-brand-500 p-5 md:p-6 rounded-r-2xl backdrop-blur-md shadow-2xl">
              <p className="text-white font-bold italic text-sm leading-relaxed mb-4">
                "The precision of wait-time tracking transformed our hub's
                reputation overnight. Simply world-class."
              </p>
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-black text-white text-[8px] uppercase tracking-widest">
                    Professional Sarah Mitchell
                  </h4>
                  <p className="text-neutral-500 text-[7px] font-black uppercase tracking-widest mt-0.5">
                    CMO, Nexa Global Health
                  </p>
                </div>
              </div>
            </div>
