      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-neutral-50 dark:bg-neutral-900 p-6">
        <div className="bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-2xl p-8 max-w-md w-full text-center shadow-sm">
          ...
          <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-6">
            Your Google sign-up session has expired or is invalid. Please start
            the sign-up process again.
          </p>
          <Link
            href="/signup"
            className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-brand-600 text-white font-semibold text-sm hover:bg-brand-700 transition-colors"
          >
      ...
      <div className="w-full md:w-1/2 min-h-screen flex flex-col justify-center px-6 sm:px-12 lg:px-24 xl:px-32 relative z-10 pt-16 md:pt-0">
        <div className="w-full max-w-[420px] mx-auto animate-fade-up">
          <div className="mb-10 text-center md:text-left">
            ...
            <p className="text-neutral-500 dark:text-neutral-400 text-sm font-medium">
              ...
              <strong className="text-neutral-700 dark:text-neutral-200">
                {prefill?.name || "a new admin"}
              </strong>{" "}
              ({prefill?.email}). Enter your organization name to finish.
            </p>
          </div>

          {msg && (
            <div
              className={`mb-6 p-4 rounded-xl border text-sm font-bold text-center ${msg.includes("created") ? "bg-success-50 dark:bg-success-900/20 border-success-200 text-success-600" : "bg-danger-50 dark:bg-danger-900/20 border-danger-200 text-danger-600"}`}
            >
              {msg}
            </div>
          )}
          ...
          <div className="mt-6 text-center md:text-left">
            <Link
              href="/login"
              className="text-sm font-semibold text-neutral-400 hover:text-brand-600 dark:hover:text-brand-400 transition-colors"
            >
              ← Go back to login
            </Link>
          </div>
      ...
      <div className="hidden md:flex w-1/2 bg-gradient-to-br from-brand-600 to-brand-800 dark:from-neutral-800 dark:to-neutral-950 text-white flex-col justify-center items-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-sm">
          ...
          <p className="text-blue-100 dark:text-neutral-400 text-base leading-relaxed">
            Your Google account is verified. Just name your organization and
            SmartQueue will set up your admin dashboard instantly.
          </p>
        </div>
      </div>
    </div>
