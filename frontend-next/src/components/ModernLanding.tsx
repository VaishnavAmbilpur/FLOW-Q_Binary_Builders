            ...
            <nav className="relative z-50 flex items-center justify-between px-8 py-8 max-w-7xl mx-auto animate-fade-up opacity-0">
                <div className="flex items-center gap-4 group cursor-pointer">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-[7px] font-black tracking-[0.4em] text-neutral-600 uppercase -mt-1">Queue Management System</span>
                    </div>
                </div>
                ...
                <div className="hidden lg:flex items-center gap-1.5 bg-white/[0.03] p-1.5 rounded-[1.5rem] border border-white/5 backdrop-blur-xl">
                    {[
                        ...
                        <Link 
                            key={item.name} 
                            href={item.path}
                            className="px-6 py-2.5 rounded-[1.2rem] text-[10px] font-black uppercase tracking-widest text-neutral-500 hover:text-white hover:bg-white/5 cursor-pointer transition-all"
                        >
                            {item.name}
                        </Link>
                    ))}
            ...
            <main className="relative z-10 w-full pt-16 pb-32">
                ...
                <div className="max-w-5xl mx-auto text-center px-8 animate-fade-up opacity-0">
                    ...
                    <h1 className="text-4xl md:text-7xl font-black tracking-tighter mb-8 text-white leading-[0.9] uppercase italic">
                        The Future of <br />
                        <span className="bg-gradient-to-r from-brand-400 via-brand-600 to-emerald-400 bg-clip-text text-transparent px-2">Patient Flow.</span>
                    </h1>

                    <p className="text-base md:text-lg text-neutral-400 font-medium mb-12 max-w-3xl mx-auto leading-relaxed">
                        FLOW-Q orchestrates the clinical environment with precision logic. <br className="hidden md:block" />
                        A high-fidelity system for real-time queue management and intelligent patient tracking.
                    </p>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                        {[
                            ...
                            <div key={stat.label} className="bg-white/[0.02] border border-white/5 rounded-3xl p-6 backdrop-blur-sm hover:bg-white/[0.04] transition-all group">
                                <div className="text-neutral-600 mb-3 group-hover:text-brand-400 transition-colors">{stat.icon}</div>
                                <div className="text-2xl font-black tracking-tighter mb-1 font-mono">{stat.val}</div>
                                <div className="text-[8px] font-black text-neutral-700 uppercase tracking-widest">{stat.label}</div>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="relative mt-24 mb-28 h-[520px] w-full max-w-7xl mx-auto px-6 animate-scale-in opacity-0">
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2 top-0 w-[90%] md:w-[70%] h-full bg-white/[0.03] border border-white/10 rounded-[3rem] p-8 backdrop-blur-3xl shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="flex flex-col md:flex-row gap-10 h-full">
                            ...
                            <div className="w-full md:w-[320px] bg-black/40 border border-white/5 rounded-[2.5rem] p-8 shadow-2xl transform group-hover:-translate-x-2 transition-transform duration-700">
                                <h3 className="text-lg font-black italic uppercase tracking-tight mb-8">Node Registry</h3>
                                <div className="space-y-6">
                                    <div className="space-y-2">
                                        <div className="text-[8px] font-black text-neutral-600 uppercase tracking-widest ml-4">Identification</div>
                                        <div className="w-full h-14 bg-white/[0.02] border border-white/5 rounded-2xl px-6 flex items-center text-xs text-neutral-500 font-mono tracking-tighter italic">Patient Identity...</div>
                                    </div>
                                    <div className="space-y-2">
                                        <div className="text-[8px] font-black text-neutral-600 uppercase tracking-widest ml-4">Clinical Reason</div>
                                        <div className="w-full h-14 bg-white/[0.02] border border-white/5 rounded-2xl px-6 flex items-center justify-between text-xs text-neutral-500">
                                            Select Protocol <ChevronDown className="w-4 h-4 opacity-30" />
                                        </div>
                                    </div>
                            ...
                            <div className="flex-1 hidden md:flex flex-col justify-between py-4">
                                <div>
                                    <div className="flex items-center gap-3 mb-10">
                                        ...
                                        <span className="text-[10px] font-black text-neutral-600 uppercase tracking-[0.4em]">Queue Throughput Integrity</span>
                                    </div>
                                    <div className="grid grid-cols-2 gap-6">
                                        {[
                                            { label: "Clinical Hub A", color: "bg-danger-500" },
                                            { label: "Clinical Hub B", color: "bg-brand-500" },
                                            { label: "Clinical Hub C", color: "bg-success-500" }
                                        ].map((hub) => (
                    ...
                    <div className="absolute z-30 right-[5%] md:right-[12%] -top-12 w-[280px] h-[560px] bg-[#050505] border-[8px] border-neutral-900 rounded-[3.5rem] shadow-2xl flex flex-col pt-8 pb-10 px-6 hidden lg:flex hover:-translate-y-6 transition-transform duration-700 cursor-none group/phone">
                        ...
                        <div className="flex-1 flex flex-col animate-fade-in">
                            ...
                            <h2 className="text-neutral-500 uppercase text-[10px] font-black tracking-[0.4em] mb-4 text-center">Neural Tracking</h2>
                            ...
                            <div className="bg-white/5 border border-white/5 rounded-[2.5rem] p-8 flex-1 flex flex-col items-center justify-center text-center relative overflow-hidden">
                                ...
                                <p className="text-[10px] font-black text-neutral-600 uppercase tracking-widest mb-2">Registry Position</p>
                                ...
                                <p className="text-[10px] font-black text-neutral-600 uppercase tracking-widest mb-2">Estimated Entry</p>
                                <span className="text-3xl font-black tracking-tight text-brand-400 font-mono italic">14:00<span className="text-[10px] ml-2 text-neutral-700">MS</span></span>
                            </div>
                            ...
                            <div className="mt-8 py-3 bg-brand-500/10 border border-brand-500/20 rounded-2xl flex items-center justify-center gap-3">
                                ...
                                <span className="text-[10px] font-black text-brand-400 uppercase tracking-widest">Global Queue Sync Active</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-8 grid md:grid-cols-3 gap-8 relative z-30 mb-32">
                    {[
                        { title: "Real-Time Clinic Sync", icon: <Globe className="w-6 h-6" />, desc: "Global registry synchronization across the clinic hub.", color: "text-brand-400 border-brand-500/20" },
                        { title: "Smart ETA Logic", icon: <Target className="w-6 h-6" />, desc: "Intelligent algorithms predicting entry latency based on load.", color: "text-emerald-400 border-emerald-500/20" },
                        { title: "Encrypted Registry", icon: <Lock className="w-6 h-6" />, desc: "Secure role-based access for clinic identities and history.", color: "text-purple-400 border-purple-500/20" }
                    ].map((feature, i) => (
                ...
                <div className="max-w-7xl mx-auto px-8 mb-28 animate-fade-up opacity-0">
                    <div className="bg-white/5 border border-white/10 rounded-[3rem] p-10 md:p-14 backdrop-blur-3xl relative overflow-hidden group">
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h2 className="text-2xl md:text-5xl font-black uppercase italic tracking-tighter mb-8 leading-tight">Patient Sync <br /> <span className="text-brand-400">Queue Architecture</span></h2>
                                <p className="text-neutral-400 text-base mb-10 leading-relaxed">
                                    Our B2B SaaS infrastructure provides a high-throughput clinical hub. <br />
                                    Leverage the same real-time synchronization logic used by our flagship panels for your own custom health ecosystems.
                                </p>
                                <div className="space-y-6">
                                    {[
                                        { title: "Universal SDK", desc: "Integrate queue logic into any React/Next.js stack." },
                                        { title: "Webhook Authority", desc: "Real-time triggers for patient entry and exit events." },
                                        { title: "Queue Prediction", desc: "Access wait-time prediction algorithms via REST." }
                                    ].map((spec) => (
                                        <div key={spec.title} className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-neutral-600 uppercase tracking-widest font-bold leading-relaxed">{spec.desc}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                            ...
                            <div className="bg-black/60 border border-white/10 rounded-[3rem] p-8 font-mono text-[10px] text-brand-400 leading-6 shadow-2xl relative">
                                <div className="flex items-center gap-2 mb-6 border-b border-white/5 pb-4">
                                    ...
                                    <span className="ml-4 text-neutral-600 font-black tracking-widest uppercase">Protocol_Sync.sys</span>
                                </div>
                                <div className="space-y-1">
                                    <p><span className="text-purple-400">POST</span> /api/v2/queue/sync</p>
                                    <p className="text-neutral-500">{"{"}</p>
                                    <p className="ml-4">"clinic_id": <span className="text-emerald-400">"CL-990-X"</span>,</p>
                                    <p className="ml-4">"protocol": <span className="text-emerald-400">"PATIENT_ENTRY"</span>,</p>
                                    <p className="ml-4">"priority": <span className="text-emerald-400">"HIGH"</span></p>
                                    <p className="text-neutral-500">{"}"}</p>
                                    <p className="mt-4 text-neutral-500">HTTP/1.1 <span className="text-brand-400">202 Accepted</span></p>
                                    <p className="text-white bg-brand-500/20 px-2 py-1 inline-block mt-2">INITIALIZING GLOBAL QUEUE BROADCAST...</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-8 mb-28 animate-fade-up opacity-0">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-black uppercase italic tracking-tighter mb-4">Enterprise Tiers</h2>
                        <div className="flex items-center justify-center gap-4">
                            <div className="h-px w-12 bg-neutral-800" />
                            <span className="text-[10px] font-black text-neutral-600 uppercase tracking-[0.5em]">Scalable Clinic Operations</span>
                            <div className="h-px w-12 bg-neutral-800" />
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            { type: "Clinic Hub", desc: "Perfect for single practitioners needing real-time queue synchronization.", icon: <User className="w-6 h-6" /> },
                            { type: "Hospital Hub", desc: "Multi-department synchronization across entire clinical campuses.", icon: <ShieldCheck className="w-6 h-6" /> },
                            { type: "B2B SaaS API", desc: "Private-label API access for custom healthcare ecosystem builders.", icon: <Cpu className="w-6 h-6" /> }
                        ].map((tier) => (
                            <div key={tier.type} className="bg-white/[0.03] border border-white/5 p-10 rounded-[3rem] hover:bg-white/[0.05] transition-all group">
                                ...
                                <p className="text-neutral-500 text-sm leading-relaxed mb-8">{tier.desc}</p>
                                <Link href="/signup" className="text-[10px] font-black uppercase tracking-[0.3em] flex items-center gap-2 text-brand-400 hover:text-white transition-colors">
                                    Analyze Plan <ChevronRight className="w-3 h-3" />
                                </Link>
                            </div>
                        ))}
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-8 mb-28 animate-fade-up opacity-0">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-black uppercase italic tracking-tighter mb-4">Command Signaling</h2>
                        <div className="flex items-center justify-center gap-4">
                            <div className="h-px w-12 bg-neutral-800" />
                            <span className="text-[10px] font-black text-neutral-600 uppercase tracking-[0.5em]">Executive Deployment Panels</span>
                            <div className="h-px w-12 bg-neutral-800" />
                        </div>
                    </div>
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-[3rem] p-10 backdrop-blur-3xl relative overflow-hidden group">
                            ...
                            <div className="flex items-center justify-between mb-12">
                                <div className="flex items-center gap-4">
                                    ...
                                    <h4 className="text-xl font-black uppercase italic tracking-tight">Clinician Hub</h4>
                                </div>
                                <span className="px-5 py-2 bg-brand-500/10 border border-brand-500/20 text-brand-400 rounded-full text-[8px] font-black uppercase tracking-widest">Active System</span>
                            </div>
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    <div key={node.id} className={`flex items-center justify-between p-6 rounded-[2rem] border transition-all ${node.active ? 'bg-brand-600 border-brand-500 text-white shadow-2xl' : 'bg-white/5 border-white/5 text-neutral-400 hover:border-white/10'}`}>
                        ...
                        <div className="bg-[#111111] border border-white/10 rounded-[3rem] p-10 backdrop-blur-3xl relative overflow-hidden group">
                            ...
                            <div className="flex items-center justify-between mb-12">
                                <div className="flex items-center gap-4">
                                    ...
                                    <h4 className="text-xl font-black uppercase italic tracking-tight">Registry Desk</h4>
                                </div>
                                <span className="px-5 py-2 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 rounded-full text-[8px] font-black uppercase tracking-widest">Gateway Hub</span>
                            </div>

                            <div className="space-y-4">
                                {[
                                    { action: "Register", color: "bg-emerald-600" },
                                    { action: "Reorder", color: "bg-white/5 border-white/10" },
                                    { action: "Terminate", color: "bg-danger-500/10 border-danger-500/20 text-danger-500" }
                                ].map((control) => (
                ...
                <div className="max-w-7xl mx-auto px-8 mb-20 animate-fade-up opacity-0">
                    <div className="bg-emerald-500/5 border border-emerald-500/10 rounded-[3rem] p-10 md:p-14 text-center relative overflow-hidden">
                        ...
                        <h2 className="text-3xl font-black uppercase italic tracking-tighter mb-4">Integrity Protocol</h2>
                        <p className="text-[10px] font-black text-neutral-500 uppercase tracking-[0.6em] mb-12">HIPAA • GDPR • ISO 27001 Compliant</p>
                    ...
                    <div className="max-w-7xl mx-auto px-10">
                        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-16 mb-32">
                            <div className="col-span-2">
                                ...
                                <p className="text-neutral-500 text-xs leading-relaxed font-medium max-w-xs mb-8">
                                    Providing high-performance queue management for the future of clinical operations. Enterprise B2B SaaS API solutions for global healthcare.
                                </p>
                            ...
                            <div>
                                ...
                                <div className="flex flex-col gap-5 text-[10px] font-black uppercase tracking-widest text-neutral-600">
                                    <Link href="/admin/dashboard" className="hover:text-brand-400 transition-colors">Admin Dashboard</Link>
                                    <Link href="/doctor" className="hover:text-brand-400 transition-colors">Doctor Portal</Link>
                                    <Link href="/reception" className="hover:text-brand-400 transition-colors">Registry Desk</Link>
                                    <Link href="/kiosk" className="hover:text-brand-400 transition-colors">Patient Kiosk</Link>
                                </div>
                            </div>                             <div>
                                <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-white mb-8">Protocols</h4>
                                <div className="flex flex-col gap-5 text-[10px] font-black uppercase tracking-widest text-neutral-600">
                                    <Link href="/docs" className="hover:text-brand-400 transition-colors">API Index</Link>
                                    <Link href="/docs#playground" className="hover:text-brand-400 transition-colors">Queue Reference</Link>
                            ...
                            <div>
                                ...
                                <div className="flex flex-col gap-5 text-[10px] font-black uppercase tracking-widest text-neutral-600">
                                    <Link href="/privacy" className="hover:text-brand-400 transition-colors">Protocol Privacy</Link>
                                    <Link href="/terms" className="hover:text-brand-400 transition-colors">System Terms</Link>
                                    <Link href="/docs" className="hover:text-brand-400 transition-colors">Compliance Hub</Link>
                                    <Link href="/docs" className="hover:text-brand-400 transition-colors">Security Audit</Link>
                                </div>
                            </div>
                        </div>
