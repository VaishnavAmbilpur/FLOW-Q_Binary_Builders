...
import {
    Activity, Shield, Lock, Smartphone, ChevronRight,
    Users, Gauge, Zap, Globe, Cpu, Power, MonitorSmartphone
} from "lucide-react";
        ...
        <div className="min-h-screen bg-neutral-950 text-white font-sans overflow-x-hidden relative selection:bg-brand-500/30">
            ...
            <main className="relative z-10 px-6 pt-12 pb-24 flex flex-col items-center text-center">
                ...
                <div className="mobile-animate-up grid grid-cols-2 gap-3 w-full opacity-0">
                    {[
                        { label: "Throughput", val: "+40%", icon: <Gauge className="w-3.5 h-3.5" /> },
                        { label: "Deployment", val: "3m", icon: <Zap className="w-3.5 h-3.5" /> },
                        { label: "Latency", val: "<2ms", icon: <Cpu className="w-3.5 h-3.5" /> },
