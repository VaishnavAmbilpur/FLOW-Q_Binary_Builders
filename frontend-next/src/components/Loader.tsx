        ...
        <div className="fixed inset-0 z-[200] flex flex-col items-center justify-center bg-neutral-950 font-sans selection:bg-brand-500/30">
            ...
            <div className="relative flex flex-col items-center">
                ...
                <div className="flex flex-col items-center text-center">
                    <h3 className="text-xl font-black text-white uppercase tracking-tighter italic mb-1">Synchronizing System</h3>
                    <div className="flex items-center gap-3">
                        ...
                        <p className="text-[10px] font-black text-neutral-600 uppercase tracking-[0.4em]">Queue System Active</p>
                    </div>
                </div>
