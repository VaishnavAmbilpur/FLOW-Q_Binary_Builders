        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/" className="flex items-center gap-4 group transition-all">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[7px] font-black tracking-[0.4em] text-neutral-500 uppercase -mt-1 opacity-60">Intelligent Queue System</span>
            </div>
          </Link>
            ...
            {navLinks.map((item) => {
              ...
              return (
                <Link
                  ...
                  `}
                >
                  <Icon className={`w-4 h-4 ${isActive ? "text-black" : "text-neutral-500 group-hover/link:text-brand-400"} transition-colors`} />
            ...
            <div className="relative">
              ...
              >
                <div className="flex flex-col text-right">
                  ...
                  <div className="text-[8px] font-black text-neutral-400 uppercase tracking-widest">{user.role?.replace("_", " ")}</div>
                </div>
              ...
              {userMenuOpen && (
                <div className="absolute right-0 mt-4 w-64 bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-white/10 rounded-[2rem] shadow-2xl overflow-hidden animate-fade-down z-[110]">
                  <div className="p-6 border-b border-neutral-100 dark:border-white/5 bg-neutral-50 dark:bg-white/[0.02]">
                    ...
                    <div className="text-[10px] text-neutral-500 truncate mb-3">{user.email}</div>
              ...
              return (
                <Link
                  ...
                  className={`
                      ...
                      : "text-neutral-500 hover:bg-neutral-50 dark:hover:bg-white/[0.02]"
                    }
                        `}
                >
