...
export default function AdminNavbar() {
  ...
  const isAuthPage =
    pathname === "/developer/login" || pathname === "/developer/signup";
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span className="font-bold text-xl tracking-tight text-neutral-900 dark:text-white mt-1">
          FLOW-Q Admin
        </span>
      </div>
        ...
        <div className="hidden md:flex gap-10 text-gray-700 dark:text-gray-200 font-medium items-center">
          {navLinks.map((item) => {
            ...
            return (
              ...
              >
                <div
                  className={`p-1.5 rounded-lg border flex items-center justify-center transition-all ${isActive ? "shadow-sm" : "opacity-80 group-hover:opacity-100"} ${item.bgClass} ${item.borderClass} ${item.textClass}`}
                >
          ...
          <div className="flex flex-col text-center py-5 gap-4 text-gray-800 dark:text-gray-200">
            {navLinks.map((item) => {
              ...
              return (
                ...
                >
                  <div
                    className={`p-1.5 rounded-lg border flex items-center justify-center ${isActive ? "shadow-sm" : "opacity-80 group-hover:opacity-100"} ${item.bgClass} ${item.borderClass} ${item.textClass}`}
                  >
