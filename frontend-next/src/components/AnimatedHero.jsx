...
export default function AnimatedHero() {
  ...
  return (
    ...
    >
      <h1
        ref={titleRef}
        className="hero-title text-5xl md:text-7xl font-extrabold text-center tracking-tight flex flex-wrap justify-center gap-x-4"
      >
        <span className="bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent inline-block opacity-0">
          Smart
        </span>
        <span className="bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent inline-block opacity-0">
          Organization
        </span>
        <span className="bg-gradient-to-r from-primary-600 to-cyan-500 dark:from-primary-400 dark:to-cyan-300 bg-clip-text text-transparent inline-block opacity-0">
          Queue
        </span>
        <span className="block w-full mt-2 text-xl md:text-3xl font-medium text-gray-600 dark:text-gray-300 opacity-0">
          Management System
        </span>
      </h1>
      ...
      <p className="hero-desc mt-6 text-xl text-gray-600 dark:text-gray-300 text-center leading-relaxed max-w-3xl mx-auto opacity-0 font-light">
        Reduce crowding, improve customer trust, real‑time updates, agent
        control & transparent queue experience — all in one elegant system.
      </p>
        ...
        {[
          {
            ...
            desc: "Live tracking, ETA & Top‑3 alerts",
            color: "text-cyan-600 dark:text-cyan-400",
            border: "border-cyan-500/30",
          },
          {
            title: "Agent Control",
            desc: "Availability + Break + Pause system",
            color: "text-emerald-600 dark:text-emerald-400",
            border: "border-emerald-500/30",
          },
          {
            title: "Secure History",
            desc: "Records + filters + secure logs",
          ...
          <div
            key={idx}
            className={`feature-card bg-white/50 dark:bg-black/50 border ${feat.border} backdrop-blur-xl 
          p-8 rounded-3xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 opacity-0 group`}
          >
            <div
              className={`w-12 h-12 rounded-2xl flex items-center justify-center mb-6 bg-gray-100 dark:bg-white/5 group-hover:scale-110 transition-transform ${feat.color}`}
            >
              <svg
                className="w-6 h-6"
                fill="none"
            ...
            <h3
              className={`font-bold text-xl mb-2 text-gray-900 dark:text-white`}
            >
              {feat.title}
            </h3>
